...
export type LeadEmailPayload = {
  ...
  documentDownloadUrl?: string; // internal-only link for the sales team — never shown to the visitor
  message?: string;
  source: string;
  submittedAt: string;
};
    ...
    <div style="font-family: Arial, sans-serif; font-size: 14px; color: #1b2233;">
      ...
      ${
        lead.documentDownloadUrl
          ? `<p style="margin-top:16px;">This visitor did not receive the file automatically — please send it directly.
