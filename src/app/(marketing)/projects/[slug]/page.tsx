...
function Fact({ label, value }: { label: string; value: string }) {
  // Some values (a long apartment-type list, a verbose community name) can run
  // much longer than others — scale the font down as length grows so they
  // wrap cleanly instead of overpowering the row.
  const sizeClass =
    value.length > 100
